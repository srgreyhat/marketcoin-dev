...
{
    const char* pszTimestamp = "Marketcoin 2 - October 7th 2022";
...
public:
    CMainParams() {
        ...
        consensus.nProtocolV1RetargetingFixedTime = 1665161450;
        consensus.nProtocolV2Time = 1665161451;
        consensus.nProtocolV3Time = 1665161452;
