...
CAmount GetProofOfWorkSubsidy()
{
    ...
    if (nBlockHeight == 1) { return 6200000 * COIN; }
}
...
CAmount GetProofOfStakeSubsidy()
{
    ...
    int halvings = nBlockHeight / 1000000; // ~ 4 years
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // Marketcoin also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // Marketcoin also requires low S in sigs
